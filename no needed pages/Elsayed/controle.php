...
<!------------------------------------------------------------------------------------------------------------------------>
					...
					<table class="table table-hover">
						...
						<tbody>
							<?php	 
								...
								{
									echo "<tr><td> ".$category['id'];
									echo "</td><td>".$category['name'];
									echo "</td><td>".$category['Products'] ."</td>";
									echo "<td><div class='btn-group btn-group-sm'><a class='btn btn-warning' href='module/server.php?method=edit&id=".$category['id'];
									echo " '>Edit</a>";
									echo "<a  class='btn btn-danger' href='module/server.php?method=delete&id=".$category['id'];
			...
			<form role='form' class='form-horizontal col-md-12' action='module/server.php' method='post'>
				<a class='col-md-2 btn btn-primary btn-lg ' value='Add new Category' id="show_add">show_add</a><br/>
				<div id="hidden">	
					<div class='form-group has-warning'>
