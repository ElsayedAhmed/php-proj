...
<!------------------------------------>
<style type="text/css">
	#namerr,#repasserr,#passerr,#emailerr,#nameval,#emailval,#passval,#repassval
	{
		position:absolute;
		margin-left:10px;
		width:200px;
...
<div class=" register">
	...
	<h1 align="center">Register</h1>
		 ...
		 <form align="center"role='form' class='form-horizontal col-md-12' action='test.php' method='post' enctype="multipart/form-data">
			<div class='form-group has-feedback' id="cname">
			<label class='col-md-2'>Name</label>
			<div class='col-md-5 input-group'>

				<span class='input-group-addon'><i class='glyphicon glyphicon-user'></i></span>
				<input placeholder='Username' class='form-control' name='name' type="text" id="name" aria-describedby="inputSuccess2Status"/>
				<span id="namerr"><font color="red">*</font></span>
				<span id="nameval"><font color="green"></font>
				<?php 
		...
		<div class='form-group ' id="cemail">
			...
			<div class='col-md-5 input-group'>
				...
				<span id="emailerr"><font color="red">*</font></span>
				<span id="emailval"><font color="green"></font>
						<?php 
		...
		<div class='form-group' id="cpass">
			...
			<div class='col-md-5 input-group'>
				...
				<span id="passerr"><font color="red">*</font></span>
				<span id="passval"><font color="green"></font>
							<?php 
		...
		<div class='form-group ' id="crepass">
			...
			<div class='col-md-5 input-group'>
				...
				<span id="repasserr"><font color="red">*</font></span>
				<span id="repassval"><font color="green"></font>
		...
		<input type='submit' class='col-md-2 btn btn-primary btn-lg' name='ok' value='Register' id="submit"/>
	</form>	
