...
$("body").on('click', "#addItem", function() {
	 ...
	 //$('span.simpleCart_total').html("<?php  insertProd(9,5,2,4,9,6,5);?>");
	 ...
	 ?>
	 	...
	 	HTMLTXT+="$product['id']";
  		HTMLTXT+="$product_price = $product['price'];";
  		HTMLTXT+="$product_image = $product['image'];";
  		HTMLTXT+="$product_name = $product['name'];";
	 	HTMLTXT+="insertProd($user_id,$product_id,$name,$order_date,$status,$price,$image);";
	 	 HTMLTXT+="insertProd(1,$product_id,$product_name,null,1,$product_price,$product_image);";
	 	HTMLTXT+="insertProd(4,5,'6',null,0,7,'8');?>";
		$('body').html(HTMLTXT);
			 	HTMLTXT+="$product = oneProd($id);";
